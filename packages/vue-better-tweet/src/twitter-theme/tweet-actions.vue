...
const favoriteCount = computed(() => formatNumber(props.tweet.favorite_count))
</script>
  ...
  <div :class="s.actions">
    ...
    >
      <div :class="s.likeIconWrapper">
        <svg viewBox="0 0 24 24" :class="s.likeIcon" aria-hidden="true">
          <g>
            <path
    ...
    >
      <div :class="s.replyIconWrapper">
        <svg viewBox="0 0 24 24" :class="s.replyIcon" aria-hidden="true">
          <g>
            <path
